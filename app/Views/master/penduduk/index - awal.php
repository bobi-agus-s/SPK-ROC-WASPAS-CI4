            ...
            <div class="card-header">
                <div class="d-flex align-items-center justify-content-between">
                    ...
                    <div>
                        ...
                        <a href="<?= site_url('penduduk/truncate'); ?>" class="btn btn-hapus btn-sm btn-outline-danger me-2">
                            <span class="fa-fw select-all fas me-2"></span>
                            Hapus Semua
                        </a>
                        <?php endif ?>
                        <?php if (user_login()->user_level == 'administrator' || user_login()->user_level == 'kasi_kesejahteraan'): ?>
                        <a href="<?= site_url('penduduk/truncate'); ?>" class="btn  btn-sm btn-outline-warning">
                            <span class="fa-fw select-all fas me-2"></span>
                            Cetak
                        </a>
                        <?php endif ?>
                                            ...
                                            <div class="d-inline-block me-2 mb-1">
                                                <div class="form-check">
                                                    <div class="custom-control custom-checkbox">
                                                        <input value="<?= $dt_penduduk->id_penduduk; ?>" type="checkbox" class="form-check-input form-check-success form-check-glow" <?= $dt_penduduk->status_pengajuan == '1' ? 'checked' : null; ?> name="customCheck" onclick="getClick('<?= site_url('penduduk/pengajuan'); ?>', this.value, <?= $dt_penduduk->status_pengajuan; ?>)">
                                                    </div>
                                                </div>
                                            </div>
                                        </td>
            ...
            <form action="<?= site_url('penduduk/filter') ?>" method="post">
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-12">
                            <h6>Status Pengajuan Bantuan</h6>
                            <fieldset class="form-group">
