            ...
            <div class="card-header">
                <div class="d-flex align-items-center justify-content-between">
                    ...
                    <div>
                        ...
                        <?php if (session('login_info')): ?>
                        <a href="<?= site_url('penduduk/truncate'); ?>" class="btn btn-hapus btn-sm btn-outline-warning">
                            <span class="fa-fw select-all fas me-2"></span>
                            Cetak
                        </a>
                        <?php endif ?>
                        <?php if (session('login_info')): ?>
                        <a href="<?= site_url('penduduk/export/filter'); ?>" class="btn btn-sm btn-outline-info">
                            <span class="fa-fw select-all fas me-2"></span>
                            Export Excel
                        </a>
                        <?php endif ?>
